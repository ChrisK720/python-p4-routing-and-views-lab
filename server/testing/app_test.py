...
class Testmain_app:
    '''Flask main_application in flask_main_app.py'''
    ...
    def test_print_route(self):
        ...
        response = main_app.test_client().get('/print/hello')
        assert(response.status_code == 200)
    ...
    def test_math_divide(self):
        ...
        response = main_app.test_client().get('/math/5/div/5')
